...
_bsn.AutoSuggest = function (fldID, param)
{
	...
	if (!this.oP.noresults)									this.oP.noresults = "Результатов не обнаружено";
...
function GetSubArray(array, value)
{
  ...
  var valPos = FindValueInArray(array, value);
  if (valPos > -1)
  {
    result[result.length] = array[valPos];
    var curPos = valPos - 1;
    while ((curPos > -1) && 
       (array[curPos].value.substr(0, value.length).toUpperCase() 
         == value.toUpperCase()))
    {
